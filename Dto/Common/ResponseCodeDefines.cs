...
namespace AuthenticationService.Dto.Common
{
    ...
    public class ResponseCodeDefines
    {
        ...
        /// 数据异常，需要重新编辑 104
        /// </summary>
        public static readonly string ProcessingDataError = ((int)ResponseCodeEnum.ProcessingDataError).ToString();
        /// <summary>
        /// 授权失效 403
        /// </summary>
        ...
        /// 参数重复 405
        /// </summary>
        public static readonly string ArgumentRepeat = ((int)ResponseCodeEnum.ArgumentRepeat).ToString();
        /// <summary>
        /// 服务器内部错误 500
        /// </summary>
    ...
    public enum ResponseCodeEnum
    {
        ...
        /// 数据异常，需要重新编辑
        /// </summary>
        [Description("数据异常，需要重新编辑")]
        ProcessingDataError = 104,
        /// <summary>
        /// 授权失效
        /// </summary>
        [Description("授权失效")]
